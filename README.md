...
Un docuement de travail doit être un dépôt de l'organisation OFCE et doit être configuré par la fonction `ofceweb::setup_wp()`. Il est nécessaire qu'il se compile sans erreur (`ofceweb::render()`)
